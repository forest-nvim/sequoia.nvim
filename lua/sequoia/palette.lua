...
local variants = {
	main = {
		...
		muted = "#fafafa", -- neutral 100
		subtle = "#525252", -- soft steel for less prominent text
		text = "#fafafa", -- crisp, neon-white text
		bark = "#FF355E", -- neon pink-red
		autumn = "#f5d0fe", --fuscia
		canopy = "#fef08a", -- soft yello
		pine = "#6ee7b7", -- green
		cloud = "#fafafa", -- cyan signage
		warm = "#FFB347", -- warm, soft amber
		leaf = "#38E8F2", -- light grey / white
