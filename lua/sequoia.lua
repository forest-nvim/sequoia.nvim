...
local function set_highlights()
	...
	local default_highlights = {
		...
		["@variable.parameter"] = { fg = palette.honey, italic = styles.italic },
		["@variable.parameter.builtin"] = { fg = palette.honey, italic = styles.italic, bold = styles.bold },
		["@variable.member"] = { fg = palette.denim },

		["@constant"] = { fg = palette.lily },
		["@constant.builtin"] = { fg = palette.lily, bold = styles.bold },
		["@constant.macro"] = { fg = palette.lily },
