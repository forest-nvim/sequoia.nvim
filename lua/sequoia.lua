...
local function set_highlights()
	...
	local legacy_highlights = {
		["@attribute.diff"] = { fg = palette.autumn },
		["@boolean"] = { link = "Boolean" },
		["@class"] = { fg = palette.cloud },
		["@conditional"] = { link = "Conditional" },
		["@field"] = { fg = palette.cloud },
		["@include"] = { link = "Include" },
		["@interface"] = { fg = palette.cloud },
		["@macro"] = { link = "Macro" },
		["@method"] = { fg = palette.canopy },
	...
	local default_highlights = {
		...
		Conceal = { bg = "NONE" },
		CurSearch = { fg = palette.base, bg = palette.autumn },
		...
		FloatTitle = { fg = palette.cloud, bg = groups.panel, bold = styles.bold },
		...
		PmenuKind = { fg = palette.cloud, bg = groups.panel },
		PmenuKindSel = { fg = palette.subtle, bg = palette.overlay },
		PmenuSbar = { bg = groups.panel },
		PmenuSel = { fg = palette.text, bg = palette.overlay },
		PmenuThumb = { bg = palette.muted },
		Question = { fg = palette.autumn },
		-- QuickFixLink = {},
		-- RedrawDebugNormal = {},
		RedrawDebugClear = { fg = palette.base, bg = palette.autumn },
		RedrawDebugComposed = { fg = palette.base, bg = palette.pine },
		RedrawDebugRecompose = { fg = palette.base, bg = palette.bark },
		Search = { fg = palette.text, bg = palette.autumn, blend = 20 },
		SignColumn = { fg = palette.text, bg = "NONE" },
		SpecialKey = { fg = palette.cloud },
		...
		Boolean = { fg = palette.canopy },
		Character = { fg = palette.autumn },
		...
		Special = { fg = palette.cloud },
		SpecialChar = { link = "Special" },
		SpecialComment = { fg = palette.warm },
		...
		TypeDef = { link = "Type" },
		Underlined = { fg = palette.warm, underline = true },
		...
		mkdCode = { fg = palette.cloud, italic = styles.italic },
		mkdCodeDelimiter = { fg = palette.canopy },
		mkdCodeEnd = { fg = palette.cloud },
		mkdCodeStart = { fg = palette.cloud },
		mkdFootnotes = { fg = palette.cloud },
		mkdID = { fg = palette.cloud, underline = true },
		...
		["@constant"] = { fg = palette.autumn },
		["@constant.builtin"] = { fg = palette.autumn, bold = styles.bold },
		["@constant.macro"] = { fg = palette.autumn },
		...
		["@type"] = { fg = palette.cloud },
		["@type.builtin"] = { fg = palette.cloud, bold = styles.bold },
		-- ["@type.definition"] = {},

		["@attribute"] = { fg = palette.warm },
		["@attribute.builtin"] = { fg = palette.warm, bold = styles.bold },
		["@property"] = { fg = palette.cloud, italic = styles.italic },

		["@function"] = { fg = palette.canopy },
		["@function.builtin"] = { fg = palette.canopy, bold = styles.bold },
		-- ["@function.call"] = {},
		["@function.macro"] = { link = "Function" },

		["@function.method"] = { fg = palette.canopy },
		...
		["@markup.heading"] = { fg = palette.cloud, bold = styles.bold },
		...
		["@markup.link.label.markdown_inline"] = { fg = palette.cloud },
		...
		["@markup.list.checked"] = { fg = palette.cloud, bg = palette.cloud, blend = 10 },
		...
		-- mvllow/modes.nvim
		ModesCopy = { bg = palette.autumn },
		ModesDelete = { bg = palette.bark },
		ModesInsert = { bg = palette.cloud },
		ModesReplace = { bg = palette.pine },
		ModesVisual = { bg = palette.warm },
		...
		NvimTreeRootFolder = { fg = palette.cloud, bold = styles.bold },
		NvimTreeSpecialFile = { link = "NvimTreeNormal" },
		NvimTreeWindowPicker = { link = "StatusLineTerm" },

		-- nvim-neotest/neotest
		NeotestAdapterName = { fg = palette.warm },
		NeotestBorder = { fg = palette.highlight_med },
		NeotestDir = { fg = palette.cloud },
		NeotestExpandMarker = { fg = palette.highlight_med },
		NeotestFailed = { fg = palette.bark },
		NeotestFile = { fg = palette.text },
		NeotestFocused = { fg = palette.autumn, bg = palette.highlight_med },
		NeotestIndent = { fg = palette.highlight_med },
		NeotestMarked = { fg = palette.canopy, bold = styles.bold },
		NeotestNamespace = { fg = palette.autumn },
		NeotestPassed = { fg = palette.pine },
		NeotestRunning = { fg = palette.autumn },
		NeotestWinSelect = { fg = palette.muted },
		NeotestSkipped = { fg = palette.subtle },
		NeotestTarget = { fg = palette.bark },
		NeotestTest = { fg = palette.autumn },
		NeotestUnknown = { fg = palette.subtle },
		NeotestWatching = { fg = palette.warm },
		...
		-- folke/flash.nvim
		FlashLabel = { fg = palette.base, bg = palette.bark },

		-- folke/which-key.nvim
		WhichKey = { fg = palette.warm },
		WhichKeyBorder = make_border(),
		WhichKeyDesc = { fg = palette.autumn },
		WhichKeyFloat = { bg = groups.panel },
		WhichKeyGroup = { fg = palette.cloud },
		WhichKeyIcon = { fg = palette.pine },
		WhichKeyIconAzure = { fg = palette.pine },
		WhichKeyIconBlue = { fg = palette.pine },
		WhichKeyIconCyan = { fg = palette.cloud },
		WhichKeyIconGreen = { fg = palette.muted },
		WhichKeyIconGrey = { fg = palette.subtle },
		WhichKeyIconOrange = { fg = palette.canopy },
		WhichKeyIconPurple = { fg = palette.warm },
		WhichKeyIconRed = { fg = palette.bark },
		WhichKeyIconYellow = { fg = palette.autumn },
		WhichKeyNormal = { link = "NormalFloat" },
		WhichKeySeparator = { fg = palette.subtle },
		WhichKeyTitle = { link = "FloatTitle" },
		WhichKeyValue = { fg = palette.canopy },

		-- lukas-reineke/indent-blankline.nvim
		IblIndent = { fg = palette.overlay },
		IblScope = { fg = palette.cloud },
		...
		NeogitFilePath = { fg = palette.cloud, italic = styles.italic },
		...
		VimwikiList = { fg = palette.warm },
		VimwikiNoExistsLink = { fg = palette.bark },
		...
		NeorgMarkerTitle = { fg = palette.cloud, bold = styles.bold },

		-- tami5/lspsaga.nvim (fork of glepnir/lspsaga.nvim)
		DefinitionCount = { fg = palette.canopy },
		DefinitionIcon = { fg = palette.canopy },
		DefinitionPreviewTitle = { fg = palette.canopy, bold = styles.bold },
		LspFloatWinBorder = make_border(),
		LspFloatWinNormal = { bg = groups.panel },
		LspSagaAutoPreview = { fg = palette.subtle },
		LspSagaCodeActionBorder = make_border(palette.canopy),
		LspSagaCodeActionContent = { fg = palette.cloud },
		LspSagaCodeActionTitle = { fg = palette.autumn, bold = styles.bold },
		LspSagaCodeActionTruncateLine = { link = "LspSagaCodeActionBorder" },
		LspSagaDefPreviewBorder = make_border(),
		LspSagaDiagnosticBorder = make_border(palette.autumn),
		LspSagaDiagnosticHeader = { fg = palette.cloud, bold = styles.bold },
		LspSagaDiagnosticTruncateLine = { link = "LspSagaDiagnosticBorder" },
		LspSagaDocTruncateLine = { link = "LspSagaHoverBorder" },
		LspSagaFinderSelection = { fg = palette.autumn },
		...
		LspSagaRenamePromptPrefix = { fg = palette.bark },
		LspSagaShTruncateLine = { link = "LspSagaSignatureHelpBorder" },
		LspSagaSignatureHelpBorder = make_border(palette.cloud),
		ReferencesCount = { fg = palette.canopy },
		ReferencesIcon = { fg = palette.canopy },
		SagaShadow = { bg = palette.overlay },
		TargetWord = { fg = palette.warm },

		-- ray-x/lsp_signature.nvim
		LspSignatureActiveParameter = { bg = palette.overlay },

		-- rlane/pounce.nvim
		PounceAccept = { fg = palette.bark, bg = palette.bark, blend = 20 },
		PounceAcceptBest = { fg = palette.autumn, bg = palette.autumn, blend = 20 },
		...
		-- phaazon/hop.nvim
		-- smoka7/hop.nvim
		HopNextKey = { fg = palette.bark, bg = palette.bark, blend = 20 },
		HopNextKey1 = { fg = palette.cloud, bg = palette.cloud, blend = 20 },
		HopNextKey2 = { fg = palette.pine, bg = palette.pine, blend = 20 },
		HopUnmatched = { fg = palette.muted },

		-- nvim-telescope/telescope.nvim
		TelescopeBorder = make_border(),
		TelescopeMatching = { fg = palette.canopy },
		TelescopeNormal = { link = "NormalFloat" },
		TelescopePromptNormal = { link = "TelescopeNormal" },
		TelescopePromptPrefix = { fg = palette.subtle },
		TelescopeSelection = { fg = palette.text, bg = palette.overlay },
		TelescopeSelectionCaret = { fg = palette.canopy, bg = palette.overlay },
		TelescopeTitle = { fg = palette.cloud, bold = styles.bold },
		...
		FzfLuaHeaderBind = { fg = palette.canopy },
		FzfLuaHeaderText = { fg = palette.bark },
		...
		NotifyTRACEBorder = make_border(palette.warm),
		NotifyTRACEIcon = { link = "NotifyTRACETitle" },
		NotifyTRACETitle = { fg = palette.warm },
		...
		DapUIBreakpointsCurrentLine = { fg = palette.autumn, bold = styles.bold },
		DapUIBreakpointsDisabledLine = { fg = palette.muted },
		DapUIBreakpointsInfo = { link = "DapUIThread" },
		DapUIBreakpointsLine = { link = "DapUIBreakpointsPath" },
		DapUIBreakpointsPath = { fg = palette.cloud },
		DapUIDecoration = { link = "DapUIBreakpointsPath" },
		DapUIFloatBorder = make_border(),
		DapUIFrameName = { fg = palette.text },
		DapUILineNumber = { link = "DapUIBreakpointsPath" },
		DapUIModifiedValue = { fg = palette.cloud, bold = styles.bold },
		DapUIScope = { link = "DapUIBreakpointsPath" },
		DapUISource = { fg = palette.warm },
		DapUIStoppedThread = { link = "DapUIBreakpointsPath" },
		DapUIThread = { fg = palette.autumn },
		DapUIValue = { fg = palette.text },
		DapUIVariable = { fg = palette.text },
		DapUIType = { fg = palette.warm },
		DapUIWatchesEmpty = { fg = palette.bark },
		...
		NavicIconsBoolean = { fg = palette.canopy },
		NavicIconsClass = { fg = palette.cloud },
		NavicIconsConstant = { fg = palette.autumn },
		NavicIconsConstructor = { fg = palette.autumn },
		NavicIconsEnum = { fg = palette.autumn },
		NavicIconsEnumMember = { fg = palette.cloud },
		NavicIconsEvent = { fg = palette.autumn },
		NavicIconsField = { fg = palette.cloud },
		NavicIconsFile = { fg = palette.muted },
		NavicIconsFunction = { fg = palette.pine },
		NavicIconsInterface = { fg = palette.cloud },
		NavicIconsKey = { fg = palette.warm },
		NavicIconsKeyword = { fg = palette.pine },
		NavicIconsMethod = { fg = palette.warm },
		...
		NavicIconsStruct = { fg = palette.cloud },
		NavicIconsTypeParameter = { fg = palette.cloud },
		...
		TroubleCount = { fg = palette.warm, bg = palette.surface },
		...
		MiniFilesTitleFocused = { fg = palette.canopy, bg = groups.panel, bold = styles.bold },
		...
		MiniIconsAzure = { fg = palette.cloud },
		MiniIconsBlue = { fg = palette.pine },
		MiniIconsCyan = { fg = palette.cloud },
		MiniIconsGreen = { fg = palette.muted },
		MiniIconsGrey = { fg = palette.subtle },
		MiniIconsOrange = { fg = palette.canopy },
		MiniIconsPurple = { fg = palette.warm },
		MiniIconsRed = { fg = palette.bark },
		MiniIconsYellow = { fg = palette.autumn },

		MiniIndentscopeSymbol = { fg = palette.muted },
		MiniIndentscopeSymbolOff = { fg = palette.autumn },

		MiniJump = { sp = palette.autumn, undercurl = true },

		MiniJump2dDim = { fg = palette.subtle },
		MiniJump2dSpot = { fg = palette.autumn, bold = styles.bold, nocombine = true },
		MiniJump2dSpotAhead = { fg = palette.cloud, bg = palette.surface, nocombine = true },
		MiniJump2dSpotUnique = { fg = palette.canopy, bold = styles.bold, nocombine = true },
		...
		MiniPickMatchRanges = { fg = palette.cloud },
		...
		MiniStarterSection = { fg = palette.canopy },
		...
		MiniStatuslineModeCommand = { fg = palette.base, bg = palette.bark, bold = styles.bold },
		MiniStatuslineModeInsert = { fg = palette.base, bg = palette.cloud, bold = styles.bold },
		MiniStatuslineModeNormal = { fg = palette.base, bg = palette.canopy, bold = styles.bold },
		MiniStatuslineModeOther = { fg = palette.base, bg = palette.canopy, bold = styles.bold },
		MiniStatuslineModeReplace = { fg = palette.base, bg = palette.pine, bold = styles.bold },
		MiniStatuslineModeVisual = { fg = palette.base, bg = palette.warm, bold = styles.bold },
		...
		MiniTestFail = { fg = palette.bark, bold = styles.bold },
		MiniTestPass = { fg = palette.cloud, bold = styles.bold },

		MiniTrailspace = { bg = palette.bark },

		-- goolord/alpha-nvim
		AlphaButtons = { fg = palette.cloud },
		AlphaFooter = { fg = palette.autumn },
		...
		TreesitterContextLineNumber = { fg = palette.canopy, bg = palette.overlay },
		...
		RainbowDelimiterCyan = { fg = palette.cloud },
		RainbowDelimiterGreen = { fg = palette.muted },
		RainbowDelimiterOrange = { fg = palette.canopy },
		RainbowDelimiterRed = { fg = palette.bark },
		RainbowDelimiterViolet = { fg = palette.warm },
		RainbowDelimiterYellow = { fg = palette.autumn },

		-- MeanderingProgrammer/render-markdown.nvim
		RenderMarkdownBullet = { fg = palette.canopy },
		RenderMarkdownChecked = { fg = palette.cloud },
		...
		GrugFarHelpHeaderKey = { fg = palette.autumn },
		GrugFarHelpWinActionKey = { fg = palette.autumn },
		GrugFarHelpWinActionPrefix = { fg = palette.cloud },
		GrugFarHelpWinActionText = { fg = palette.pine },
		GrugFarHelpWinHeader = { link = "FloatTitle" },
		GrugFarInputLabel = { fg = palette.cloud },
		GrugFarInputPlaceholder = { link = "Comment" },
		GrugFarResultsActionMessage = { fg = palette.cloud },
		GrugFarResultsChangeIndicator = { fg = groups.git_change },
		GrugFarResultsHeader = { fg = palette.pine },
		GrugFarResultsLineNo = { fg = palette.warm },
		GrugFarResultsLineColumn = { link = "GrugFarResultsLineNo" },
		GrugFarResultsMatch = { link = "CurSearch" },
		GrugFarResultsPath = { fg = palette.cloud },
		GrugFarResultsStats = { fg = palette.warm },

		-- yetone/avante.nvim
		AvanteTitle = { fg = palette.highlight_high, bg = palette.canopy },
		AvanteReversedTitle = { fg = palette.canopy },
		AvanteSubtitle = { fg = palette.highlight_med, bg = palette.cloud },
		AvanteReversedSubtitle = { fg = palette.cloud },
		AvanteThirdTitle = { fg = palette.highlight_med, bg = palette.warm },
		AvanteReversedThirdTitle = { fg = palette.warm },
		...
		BlinkCmpKindMethod = { fg = palette.cloud },
		BlinkCmpKindFunction = { fg = palette.cloud },
		BlinkCmpKindConstructor = { fg = palette.cloud },
		BlinkCmpKindField = { fg = palette.pine },
		BlinkCmpKindVariable = { fg = palette.canopy },
		BlinkCmpKindClass = { fg = palette.autumn },
		BlinkCmpKindInterface = { fg = palette.autumn },
		BlinkCmpKindModule = { fg = palette.cloud },
		BlinkCmpKindProperty = { fg = palette.cloud },
		BlinkCmpKindUnit = { fg = palette.pine },
		BlinkCmpKindValue = { fg = palette.bark },
		BlinkCmpKindKeyword = { fg = palette.warm },
		BlinkCmpKindSnippet = { fg = palette.canopy },
		BlinkCmpKindColor = { fg = palette.bark },
		BlinkCmpKindFile = { fg = palette.cloud },
		BlinkCmpKindReference = { fg = palette.bark },
		BlinkCmpKindFolder = { fg = palette.cloud },
		BlinkCmpKindEnum = { fg = palette.cloud },
		BlinkCmpKindEnumMember = { fg = palette.cloud },
		BlinkCmpKindConstant = { fg = palette.autumn },
		BlinkCmpKindStruct = { fg = palette.cloud },
		BlinkCmpKindEvent = { fg = palette.cloud },
		BlinkCmpKindOperator = { fg = palette.cloud },
		BlinkCmpKindTypeParameter = { fg = palette.warm },
		BlinkCmpKindCodeium = { fg = palette.cloud },
		BlinkCmpKindCopilot = { fg = palette.cloud },
		BlinkCmpKindSupermaven = { fg = palette.cloud },
		BlinkCmpKindTabNine = { fg = palette.cloud },

		-- folke/snacks.nvim
		SnacksIndent = { fg = palette.overlay },
		SnacksIndentChunk = { fg = palette.overlay },
		SnacksIndentBlank = { fg = palette.overlay },
		SnacksIndentScope = { fg = palette.cloud },

		SnacksPickerMatch = { fg = palette.canopy, bold = styles.bold },

		-- justinmk/vim-sneak
		Sneak = { fg = palette.base, bg = palette.bark },
	...
	local transparency_highlights = {
		...
		FloatTitle = { fg = palette.cloud, bg = "NONE", bold = styles.bold },
		...
		PmenuKind = { fg = palette.cloud, bg = "NONE" },
		SignColumn = { fg = palette.text, bg = "NONE" },
		...
		-- ["@markup.raw"] = { bg = "none" },
		["@markup.raw.markdown_inline"] = { fg = palette.autumn },
		...
		TelescopeSelectionCaret = { fg = palette.canopy },
		...
		IblScope = { fg = palette.cloud, bg = "NONE" },
		IblWhitespace = { fg = palette.overlay, bg = "NONE" },

		TreesitterContext = { bg = "NONE" },
		TreesitterContextLineNumber = { fg = palette.canopy, bg = "NONE" },

		MiniFilesTitleFocused = { fg = palette.canopy, bg = "NONE", bold = styles.bold },
	...
	if config.options.enable.terminal then
		...
		vim.g.terminal_color_1 = palette.bark -- red
		vim.g.terminal_color_9 = palette.bark -- bright red
		vim.g.terminal_color_2 = palette.pine -- green
		vim.g.terminal_color_10 = palette.pine -- bright green
		vim.g.terminal_color_3 = palette.autumn -- yellow
		vim.g.terminal_color_11 = palette.autumn -- bright yellow
		vim.g.terminal_color_4 = palette.cloud -- blue
		vim.g.terminal_color_12 = palette.cloud -- bright blue
		vim.g.terminal_color_5 = palette.warm -- magenta
		vim.g.terminal_color_13 = palette.warm -- bright magenta
		vim.g.terminal_color_6 = palette.canopy -- cyan
		vim.g.terminal_color_14 = palette.canopy -- bright cyan
