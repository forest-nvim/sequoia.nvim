...
local function set_highlights()
	...
	local default_highlights = {
		...
		DiagnosticVirtualTextError = { fg = palette.subtle, bg = palette.error, blend = 10 },
		DiagnosticVirtualTextHint = { fg = palette.subtle, bg = palette.grass, blend = 10 },
		DiagnosticVirtualTextInfo = { fg = palette.subtle, bg = palette.denim, blend = 10 },
		DiagnosticVirtualTextOk = { fg = palette.subtle, bg = palette.subtle, blend = 10 },
		DiagnosticVirtualTextWarn = { fg = palette.subtle, bg = palette.honey, blend = 10 },
		...
		LspInlayHint = { fg = palette.subtle, bg = palette.subtle, blend = 10 },
		...
		WhichKey = { fg = palette.sun },
		WhichKeyBorder = make_border(),
		WhichKeyDesc = { fg = palette.text },
		WhichKeyFloat = { bg = groups.panel },
		WhichKeyGroup = { fg = palette.denim },
		WhichKeyIconAzure = { fg = palette.denim },
		WhichKeyIconBlue = { fg = palette.sky },
		WhichKeyIconCyan = { fg = palette.baja },
		WhichKeyIconGreen = { fg = palette.grass },
		WhichKeyIconGrey = { fg = palette.subtle },
		WhichKeyIconOrange = { fg = palette.honey },
		WhichKeyIconPurple = { fg = palette.lavendar },
		WhichKeyIconRed = { fg = palette.error },
		WhichKeyIconYellow = { fg = palette.sun },
		WhichKeyNormal = { link = "NormalFloat" },
		WhichKeySeparator = { fg = palette.subtle },
		WhichKeyTitle = { link = "FloatTitle" },
		WhichKeyValue = { fg = palette.subtle },

		-- folke/flash.nvim
		FlashBackdrop = { fg = palette.subtle },
		FlashCurrent = { fg = palette.text, bg = palette.highlight_high },
		FlashLabel = { fg = palette.base, bg = palette.lily, bold = styles.bold },
		FlashMatch = { fg = palette.text, bg = palette.lily, blend = 20 },

		-- stevearc/overseer.nvim
		OverseerCANCELED = { fg = palette.subtle },
		OverseerDISPOSED = { fg = palette.subtle },
		OverseerFAILURE = { fg = groups.error },
		OverseerPENDING = { fg = palette.honey },
		OverseerRUNNING = { fg = palette.denim },
		OverseerSUCCESS = { fg = palette.grass },
		OverseerComponent = { fg = palette.lavendar },
		OverseerField = { fg = palette.sky },
		OverseerOutput = { fg = palette.text },
		OverseerTask = { fg = palette.sun },
		OverseerTaskBorder = make_border(),

		-- folke/snacks.nvim
		SnacksDashboardNormal = { link = "Normal" },
		SnacksDashboardDesc = { fg = palette.denim },
		SnacksDashboardDir = { fg = palette.subtle },
		SnacksDashboardFile = { fg = palette.text },
		SnacksDashboardFooter = { fg = palette.lily },
		SnacksDashboardHeader = { fg = palette.baja },
		SnacksDashboardIcon = { fg = palette.denim },
		SnacksDashboardKey = { fg = palette.sun },
		SnacksDashboardSpecial = { fg = palette.honey },
		SnacksDashboardTitle = { fg = palette.denim, bold = styles.bold },

		SnacksIndent = { fg = palette.overlay },
		SnacksIndentScope = { fg = palette.denim },
		SnacksIndentChunk = { fg = palette.denim },
		SnacksIndentBlank = { fg = palette.overlay },

		SnacksInputNormal = { link = "NormalFloat" },
		SnacksInputBorder = make_border(),
		SnacksInputTitle = { link = "FloatTitle" },
		SnacksInputIcon = { fg = palette.denim },

		SnacksNotifierInfo = { fg = palette.denim },
		SnacksNotifierWarn = { fg = palette.honey },
		SnacksNotifierError = { fg = palette.error },
		SnacksNotifierDebug = { fg = palette.subtle },
		SnacksNotifierTrace = { fg = palette.lavendar },
		SnacksNotifierIconInfo = { fg = palette.denim },
		SnacksNotifierIconWarn = { fg = palette.honey },
		SnacksNotifierIconError = { fg = palette.error },
		SnacksNotifierIconDebug = { fg = palette.subtle },
		SnacksNotifierIconTrace = { fg = palette.lavendar },
		SnacksNotifierBorderInfo = make_border(palette.denim),
		SnacksNotifierBorderWarn = make_border(palette.honey),
		SnacksNotifierBorderError = make_border(palette.error),
		SnacksNotifierBorderDebug = make_border(palette.subtle),
		SnacksNotifierBorderTrace = make_border(palette.lavendar),
		SnacksNotifierTitleInfo = { fg = palette.denim },
		SnacksNotifierTitleWarn = { fg = palette.honey },
		SnacksNotifierTitleError = { fg = palette.error },
		SnacksNotifierTitleDebug = { fg = palette.subtle },
		SnacksNotifierTitleTrace = { fg = palette.lavendar },

		SnacksPickerBorder = make_border(),
		SnacksPickerTitle = { fg = palette.denim, bold = styles.bold },
		SnacksPickerPrompt = { fg = palette.subtle },
		SnacksPickerMatch = { fg = palette.sun, bold = styles.bold },
		SnacksPickerNormal = { link = "NormalFloat" },
		SnacksPickerDir = { fg = palette.subtle },
		SnacksPickerFile = { fg = palette.text },
		SnacksPickerSelected = { fg = palette.text, bg = palette.overlay },
		SnacksPickerGitAdded = { fg = groups.git_add },
		SnacksPickerGitDeleted = { fg = groups.git_delete },
		SnacksPickerGitModified = { fg = groups.git_change },
		SnacksPickerGitUntracked = { fg = groups.git_untracked },

		SnacksScrollBar = { fg = palette.highlight_high },
		SnacksZen = { link = "Normal" },
	}
	local transparency_highlights = {
		DiagnosticVirtualTextError = { fg = palette.subtle },
		DiagnosticVirtualTextHint = { fg = palette.subtle },
		DiagnosticVirtualTextInfo = { fg = palette.subtle },
		DiagnosticVirtualTextOk = { fg = palette.subtle },
		DiagnosticVirtualTextWarn = { fg = palette.subtle },
		...
		FlashCurrent = { fg = palette.text, bg = "NONE", bold = styles.bold },

		OverseerTaskBorder = { fg = palette.sky, bg = "NONE" },

		SnacksDashboardNormal = { bg = "NONE" },
		SnacksIndent = { fg = palette.overlay, bg = "NONE" },
		SnacksIndentScope = { fg = palette.denim, bg = "NONE" },
		SnacksIndentChunk = { fg = palette.denim, bg = "NONE" },
